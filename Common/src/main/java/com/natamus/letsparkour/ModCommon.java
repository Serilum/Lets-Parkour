...
public class ModCommon {
	...
	public static void registerAssets(Object modEventBusObject) {
		...
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "base_parkour_slab"), () -> new ParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(1.2F, 6.0F)), functionalBlocksResourceKey);
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "soft_parkour_slab"), () -> new SoftParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_YELLOW).strength(1.2F, 6.0F)), functionalBlocksResourceKey);

		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "slow_parkour_slab"), () -> new SlowParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.GOLD).strength(1.2F, 6.0F)), functionalBlocksResourceKey);
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "fast_parkour_slab"), () -> new FastParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BLUE).strength(1.2F, 6.0F)), functionalBlocksResourceKey);

		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "jelly_parkour_slab"), () -> new JellyParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).strength(1.2F, 6.0F).forceSolidOn().noCollission().isViewBlocking((a, b, c) -> { return false; })), functionalBlocksResourceKey);
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "jump_parkour_slab"), () -> new JumpParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_GREEN).strength(1.2F, 6.0F)), functionalBlocksResourceKey);
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "slippery_parkour_slab"), () -> new SlipperyParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.ICE).strength(1.2F, 6.0F)), functionalBlocksResourceKey);
		...
		Services.REGISTERBLOCK.registerBlockWithItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "trapdoor_parkour_slab"), () -> new TrapdoorParkourSlab(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(1.2F, 6.0F)), functionalBlocksResourceKey, true);
	}
